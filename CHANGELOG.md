...
### Added
- Local Parquet import through `IMPORT INTO <table> FROM LOCAL PARQUET FILE '<path>'` for Exasol 2025.1.9 and later
- Direct CSV export for a table or parenthesized query through the `Exasol: Export Table or Query to CSV` command
